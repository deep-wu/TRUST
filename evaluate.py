...
parser.add_argument('--arch', type=str, default='ResNet18',
                    choices=['WideResNet', 'ResNet18', 'PreActResNet18', 'VGG16'])
# data
parser.add_argument(
...
parser.add_argument(
    "--checkpoint",
    type=str, default="results/checkpoint.tar",
    ...
    with torch.no_grad():
        for data, target in test_loader:
            ...
            with torch.enable_grad():
                adv_data = attack.run_standard_evaluation(data.float(), target, bs=128).cuda()
